...
```{r}
ggplot(data=vgsales, aes(x=reorder(Platform, -Global_Sales),y=Global_Sales)) + #reorder isnt working?
  geom_bar(stat='identity',position='stack', width=.9) +
  theme(axis.text.x=element_text(angle=60,hjust=1)) +xlab("Platform") + ylab("Global Sales")
```
